...
@.str = private unnamed_addr constant [10 x i8] c"ans = %d\0A\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 @gcd(i32 9, i32 36)
  %3 = call i32 @gcd(i32 3, i32 6)
  %4 = mul nsw i32 %2, %3
  store i32 %4, i32* @ans, align 4
  %5 = load i32, i32* @ans, align 4
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %5)
  ret i32 0
}
